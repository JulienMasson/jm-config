...
sudo apt-get install xinit cscope slock numlockx offlineimap alsa-utils dmenu aptitude pcmanfm texlive iceweasel flashplugin-nonfree evince mairix eog install-info -y
