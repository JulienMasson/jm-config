...
sudo apt-get install xinit rxvt-unicode arandr cscope offlineimap alsa-utils pulseaudio rofi i3lock-fancy dunst tint2 thunar evince mairix eog install-info -y
