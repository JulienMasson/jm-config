...
-- Network widget
netgraphwidget = awful.widget.graph()
netgraphwidget:set_width(50)
netgraphwidget:set_height(30)
netgraphwidget:set_background_color("#494B4F")
netgraphwidget:set_color("#FF5656")
netgraphwidget:set_gradient_colors({ "#FF5656", "#88A175", "#AECF96" })

netgraphwidget_t = awful.tooltip({ objects = { netgraphwidget.widget },})

-- Register network widget
vicious.register(netgraphwidget, vicious.widgets.net,
                    function (widget, args)
                        netgraphwidget_t:set_text("Network download: " .. args["{eth0 down_mb}"] .. "mb/s")
