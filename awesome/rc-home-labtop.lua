...
wlan_up_speedwidget = widget({ type = "textbox" })
vicious.register(wlan_up_speedwidget, vicious.widgets.net, '${wlan0 up_kb}Kb', 1)
wlan_down_speedwidget = widget({ type = "textbox" })
vicious.register(wlan_down_speedwidget, vicious.widgets.net, '${wlan0 down_kb}Kb', 1)
