...
local cpu_graph = blingbling.line_graph({height = 20,
					 width = 100,
					 font_size = 8,
					 show_text = true,
					 label = "CPU: $percent %",
					 rounded_size = 0.3,
					 graph_color = "#ff330088",
					 graph_line_color = "#ff330088",
})
local vicious = require("vicious")
vicious.register(cpu_graph, vicious.widgets.cpu,'$1',2)

local cpu_degree = wibox.widget.textbox()
vicious.register(cpu_degree, vicious.widgets.thermal, "$1 °C", 30, { "thermal_zone0", "sys"})

-- RAM
local ram_graph = blingbling.line_graph({height = 20,
					 width = 100,
					 font_size = 8,
					 show_text = true,
					 label = "RAM: $percent %",
					 roundCed_size = 0.3,
					 graph_color = "#00ccff88",
					 graph_line_color = "#00ccff88",
})
vicious.register(ram_graph, vicious.widgets.mem,'$1',2)

local ram_usage = wibox.widget.textbox()
vicious.register(ram_usage, vicious.widgets.mem, "$2 MB", 2)
...
local batt_graph = blingbling.progress_graph({height = 18,
					      ...
					      rounded_size = 0.3,
					      graph_color = "#A6E22E",
					      graph_line_color = "#A6E22E",
})
vicious.register(batt_graph, vicious.widgets.bat, "$2", 5, "BAT1")
