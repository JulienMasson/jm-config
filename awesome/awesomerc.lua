...
-- beautiful.init("/home/lab/bin/awesome-repo/themes/default/theme.lua")
beautiful.init("/home/lab/jm-config/awesome/theme.lua")
...
-- Battery
local batt_graph = blingbling.line_graph({height = 20,
          	                          width = 100,
                 			  show_text = true,
                                          label = "Batt: $percent %",
                                          rounded_size = 0.3,
                                      })
vicious.register(batt_graph, vicious.widgets.bat, "$2", 5, "BAT0")
