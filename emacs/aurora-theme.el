...
;;;;; basic coloring
   ...
   `(cursor ((t (:foreground ,aurora-fg :background ,aurora-orange+1))))
...
;;;;; magit
   ...
   `(magit-diff-added ((t :inherit diff-added :foreground ,aurora-green+5 )))
   `(magit-diff-added-highlight ((t :inherit diff-added :foreground ,aurora-green+5 :background ,aurora-bg-05)))
   `(magit-diff-removed ((t :inherit diff-removed  :foreground ,aurora-red+1)))
   `(magit-diff-removed-highlight ((t :inherit diff-removed :foreground ,aurora-red+1 :background ,aurora-bg-05)))
   `(magit-diff-file-heading-highlight ((t :background ,aurora-bg-05)))
   `(magit-diff-hunk-heading-highlight ((t :background ,aurora-bg-05)))
   `(magit-diff-context-highlight ((t :background ,aurora-bg-05)))
